            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-12 me-auto mb-4 mb-lg-0">
                    ...
                    <p><strong>Since 1984</strong>, Tiya is ranked #8 in the top 10 golf courses in the world. Tiya is
                        Bootstrap 5 HTML CSS template for golf clubs. Anyone can modify and use this layout for commercial
                        purposes.</p>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5 col-12 mx-auto">
                    ...
                    <form enctype="multipart/form-data" action=<?php echo e(route('member.store')); ?> method="post"
                        class="custom-form membership-form shadow-lg" role="form">
                        <?php echo csrf_field(); ?>
                        <h4 class="text-white mb-4">Become a member</h4>

                        <?php if(session('success')): ?>
                            <div class="alert alert-primary text-center"><?php echo e(session('success')); ?></div>
                        <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel\abdo\resources\views/home.blade.php ENDPATH**/ ?>