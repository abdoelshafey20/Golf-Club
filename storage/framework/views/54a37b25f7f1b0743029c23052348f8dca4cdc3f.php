    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-lg-auto">
                <li class="nav-item">
                    <a class="nav-link click-scroll" href="<?php echo e(route('homepage')); ?>">Home</a>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarLightDropdownMenuLink">
                        <li><a class="dropdown-item" href=<?php echo e(route('list')); ?>>Event Listing</a></li>

                        <li><a class="dropdown-item" href=<?php echo e(route('details')); ?>>Event Detail</a></li>
                    </ul>
                </li>
...
<?php /**PATH C:\laravel\abdo\resources\views/temp/navbar.blade.php ENDPATH**/ ?>